...
from .piecewise import optimal_threshold_sortscan, get_vectorized_metric
...
def metric_score(
    ...
    if metric not in METRIC_REGISTRY:
        raise ValueError(f"Metric '{metric}' not supported. Available: {list(METRIC_REGISTRY.keys())}")
