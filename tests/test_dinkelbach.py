...
class TestDinkelbachMethod:
    ...
    def test_dinkelbach_unsupported_metric(self):
        ...
        with pytest.raises(ValueError, match="dinkelbach method currently only supports F1 metric"):
            get_optimal_threshold(y_true, y_prob, metric="accuracy", method="dinkelbach")
    ...
    def test_dinkelbach_no_sample_weights(self):
        ...
        with pytest.raises(ValueError, match="dinkelbach method does not support sample weights"):
