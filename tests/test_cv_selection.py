...
from optimal_cutoffs.cv import cv_threshold_optimization, nested_cv_threshold_optimization
...
class TestNestedCrossValidation:
    ...
    def test_nested_cv_threshold_selection_consistency(self):
        ...
        try:
            from optimal_cutoffs.cv import nested_cv_threshold_selection, cross_val_score_threshold
        except ImportError:
            pytest.skip("Nested CV not available")
